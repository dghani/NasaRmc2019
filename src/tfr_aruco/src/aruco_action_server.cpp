...
class TFR_Aruco {
    public:
        ...
        void execute(const tfr_msgs::ArucoGoalConstPtr& goal)
        {
            ...
            try {
                imageHolder = cv_bridge::toCvCopy(goal->image, sensor_msgs::image_encodings::passthrough);
            } 
            ...
            #ifdef DRAW_MARKERS
            cv_bridge::CvImagePtr drawnImageHolder = cv_bridge::toCvCopy(goal->image, sensor_msgs::image_encodings::passthrough);
