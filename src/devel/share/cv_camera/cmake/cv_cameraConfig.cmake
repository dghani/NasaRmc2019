...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/phillipov/NasaRmc2019/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/phillipov/NasaRmc2019/src/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/phillipov/NasaRmc2019/src/cv_camera/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/phillipov/NasaRmc2019/src/cv_camera/include;/usr/local/include;/usr/local/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/phillipov/NasaRmc2019/src/cv_camera/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_camera_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_camera;/usr/local/lib/libopencv_calib3d.so.3.4.6;/usr/local/lib/libopencv_core.so.3.4.6;/usr/local/lib/libopencv_features2d.so.3.4.6;/usr/local/lib/libopencv_highgui.so.3.4.6;/usr/local/lib/libopencv_imgcodecs.so.3.4.6;/usr/local/lib/libopencv_imgproc.so.3.4.6;/usr/local/lib/libopencv_videoio.so.3.4.6;/usr/local/lib/libopencv_aruco.so.3.4.6")
