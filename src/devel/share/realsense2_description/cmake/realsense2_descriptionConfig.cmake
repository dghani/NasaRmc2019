...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /home/phillipov/NasaRmc2019/src/ros_realsense/realsense/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /home/phillipov/NasaRmc2019/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/phillipov/NasaRmc2019/src/ros_realsense/realsense/realsense2_description/${idir}'.  ${_report}")
    endif()
