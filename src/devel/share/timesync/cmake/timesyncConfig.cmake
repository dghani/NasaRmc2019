...
if("TRUE" STREQUAL "TRUE")
  set(timesync_SOURCE_PREFIX /home/phillipov/NasaRmc2019/src/timesync)
  set(timesync_DEVEL_PREFIX /home/phillipov/NasaRmc2019/src/devel)
  set(timesync_INSTALL_PREFIX "")
  set(timesync_PREFIX ${timesync_DEVEL_PREFIX})
else()
  set(timesync_SOURCE_PREFIX "")
  set(timesync_DEVEL_PREFIX "")
  set(timesync_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/phillipov/NasaRmc2019/src/devel/include;/home/phillipov/NasaRmc2019/src/timesync/include " STREQUAL " ")
  set(timesync_INCLUDE_DIRS "")
  set(_include_dirs "/home/phillipov/NasaRmc2019/src/devel/include;/home/phillipov/NasaRmc2019/src/timesync/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timesync' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/phillipov/NasaRmc2019/src/timesync/${idir}'.  ${_report}")
    endif()
