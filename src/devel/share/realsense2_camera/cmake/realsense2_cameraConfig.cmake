...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/phillipov/NasaRmc2019/src/ros_realsense/realsense/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/phillipov/NasaRmc2019/src/devel)
...
if(NOT "/home/phillipov/NasaRmc2019/src/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/phillipov/NasaRmc2019/src/ros_realsense/realsense/realsense2_camera/${idir}'.  ${_report}")
    endif()
